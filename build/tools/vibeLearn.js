import { addLearningEntry, getLearningCategorySummary, getLearningEntries } from '../utils/storage.js';
/**
 ...
 */
export async function vibeLearnTool(input) {
    try {
        // Validate input
        if (!input.mistake) {
        ...
        const entryType = input.type ?? 'mistake';
 ...
 */
function enforceOneSentence(text) {
    // Remove newlines
