 ...
 */
export function createSessionId(components) {
    const { projectId, workType, linearIssueId = 'adhoc', timestamp = getCurrentTimestamp(), uuid = generateShortUUID() } = components;
    if (!projectId) {
 ...
 */
export function extractWorkType(sessionId) {
 ...
 */
export function extractProjectId(sessionId) {
    const components = parseSessionId(sessionId);
 ...
 */
export function extractLinearIssueId(sessionId) {
    const components = parseSessionId(sessionId);
 ...
 */
export function createSessionIdPattern(projectId, workType, linearIssueId) {
    const parts = [];
    if (projectId) {
