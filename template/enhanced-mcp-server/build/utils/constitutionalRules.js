...
import os from 'os';
import { getEffectiveRules } from './constitutional/rule-resolver.js';
/**
 * Get the path to the constitutional rules file
 */
export function getConstitutionalRulesPath(config) {
 ...
 */
export function loadConstitutionalRules(config) {
 ...
 */
export function rulesToStrings(rules) {
 ...
 */
export function loadConstitutionalRulesAsStrings(config) {
 ...
 */
export function getConstitutionalRulesContext(config) {
    const rules = loadConstitutionalRules(config);
    if (rules.length === 0) {
        return '';
    }
 ...
 */
export function validateConstitutionalRules(config) {
    const rulesPath = getConstitutionalRulesPath(config);
    if (!rulesPath) {
        return {
            valid: false,
