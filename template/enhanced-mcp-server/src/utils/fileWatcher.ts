...
interface WatcherOptions {
  debounceMs?: number;
  onReload?: (rulesPath: string, ruleCount: number) => void;
...
class ConstitutionalRulesWatcher {
  ...
  private currentRulesPath: string | null = null;
   ...
   */
  private clearConstitutionCache(): void {
   ...
   */
  private watchInheritanceChain(rulesPath: string): void {
    try {
...
// Singleton instance
let globalWatcher: ConstitutionalRulesWatcher | null = null;
 ...
 */
export function getWatcher(): ConstitutionalRulesWatcher | null {
